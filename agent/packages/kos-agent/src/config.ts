...
export const ENV_AGENT_DIR = APP_NAME === "kos-agent" ? "KOS_AGENT_DIR" : `${APP_NAME.toUpperCase()}_CODING_AGENT_DIR`;
export const ENV_SESSION_DIR =
	APP_NAME === "kos-agent" ? "KOS_AGENT_SESSION_DIR" : `${APP_NAME.toUpperCase()}_CODING_AGENT_SESSION_DIR`;
