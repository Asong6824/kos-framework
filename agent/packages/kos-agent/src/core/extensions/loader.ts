...
// avoiding a circular dependency. kos extensions use @kos-framework/kos-agent;
// the upstream package aliases remain available for imported Pi extensions.
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@kos-framework/kos-agent": _bundledPiCodingAgent,
...
function getAliases(): Record<string, string> {
	...
	_aliases = {
		...
		"@kos-framework/kos-agent": piCodingAgentEntry,
