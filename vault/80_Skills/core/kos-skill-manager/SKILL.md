...
- 必须读取 `.kos.md`；Hermes 环境下同时读取 `.hermes.md`、`80_Skills/README.md` 和 `90_系统/规则/对象规范.md`。
...
```text
80_Skills/core/<skill-name>/SKILL.md
80_Skills/integrations/<external_system>/<skill-name>/SKILL.md
80_Skills/personal/<domain>/<skill-name>/SKILL.md
80_Skills/archived/<skill-name>/SKILL.md
```
